...
Every use case here passes a simple test:
...
| Use Case | Category | Time to Setup | Daily Value |
|----------|----------|---------------|-------------|
| [Freelancer Lead Pipeline](usecases/freelancer-lead-pipeline.md) | Sales | 30 min | Find + win more gigs |
| [Content Multiplication](usecases/content-multiplication.md) | Marketing | 15 min | 1 post → 7 platforms |
| [Invoice Chaser](usecases/invoice-chaser.md) | Finance | 20 min | Get paid faster |
| [Competitor Radar](usecases/competitor-radar.md) | Marketing | 15 min | Never miss market moves |
| [Lead Scoring](usecases/lead-scoring.md) | Sales | 25 min | Focus on hot leads |
| [Cold Outreach](usecases/cold-outreach.md) | Sales | 30 min | Personalized at scale |
...
| Use Case | Category | Time to Setup | Daily Savings |
|----------|----------|---------------|---------------|
...
| Use Case | Category | Time to Setup | Benefit |
|----------|----------|---------------|---------|
| [Server Health Monitor](usecases/server-health-monitor.md) | DevOps | 20 min | Sleep peacefully |
